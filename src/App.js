...
function App() {
  ...
  return (
    <div className="flex justify-center h-screen">
      <div className="cardBorder rounded overflow-hidden shadow-lg border-gray-400 border w-full md:w-10/12 lg:w-7/12 m-auto p-8">
        ...
        <div className="w-11/12 py-4 text-center my-2 mx-auto relative">
          <button
            className="generatePasswordButton bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow w-full"
            onClick={() => {
              randomPassword();
            }}
          >
